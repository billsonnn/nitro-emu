import { NumberHelper } from '../utilities';
...
export class Direction
{
    ...
    public static getRandomStandardDirection(): number
    {
        return NumberHelper.getRandomValue([ 0, 2, 4, 6 ]);
    }

    public static getRandomDirection(): number
    {
        return NumberHelper.getRandomValue([ 0, 1, 2, 3, 4, 5, 6, 7 ]);
    }
}