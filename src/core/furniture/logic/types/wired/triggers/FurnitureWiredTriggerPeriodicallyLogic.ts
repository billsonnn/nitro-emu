...
export class FurnitureWiredTriggerPeriodicallyLogic extends FurnitureWiredTriggerLogic
{
    ...
    private startTriggering(): void
    {
        ...
        let interval = (this.wiredData && this.wiredData.intParameters[FurnitureWiredTriggerPeriodicallyLogic.INTERVAL_PARAMETER]) || 1;
    ...
    {
        return FurnitureWiredTriggerType.TRIGGER_PERIODICALLY;
    }
}