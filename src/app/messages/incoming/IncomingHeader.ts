export class IncomingHeader
{
    ...
    public static CATALOG_DISCOUNT_CONFIG              = 223;
    public static CATALOG_GIFT_CONFIG                  = 418;
    public static CATALOG_MARKETPLACE_CONFIG           = 2597;
    public static CATALOG_MODE                         = 1195;
    public static CATALOG_PAGE                         = 412;
    public static CATALOG_PURCHASE                     = 3492;
    public static CATALOG_RECYCLER_PRIZES              = 398;
    public static CATALOG_SEARCH                       = 2594;
    public static CLIENT_EVENT_TRACKER                 = 3457;
    ...
    public static CLIENT_RELEASE_VERSION               = 4000;
    ...
    public static FURNITURE_LOGIC_DICE_CLOSE           = 1533;
    public static FURNITURE_LOGIC_DICE_OPEN            = 1990;
    public static FURNITURE_LOGIC_EXCHANGE             = 3115;
    public static FURNITURE_LOGIC_MULTISTATE           = 99;
    public static FURNITURE_LOGIC_STACK_HELPER         = 3839;
    public static FURNITURE_LOGIC_WIRED_ACTION_SAVE    = 2281;
    public static FURNITURE_LOGIC_WIRED_CONDITION_SAVE = 3203;
    public static FURNITURE_LOGIC_WIRED_TRIGGER_SAVE   = 1520;
    ...
    public static ROOM_ACCESS_BAN_GIVE                 = 1477;
    public static ROOM_ACCESS_BAN_LIST                 = 2267;
    public static ROOM_ACCESS_BAN_REMOVE               = 992;
    public static ROOM_ACCESS_DOORBELL                 = 1644;
    public static ROOM_ACCESS_ENTER                    = 2312;
    public static ROOM_ACCESS_KICK                     = 1320;
    public static ROOM_ACCESS_MUTE                     = 3637;
    public static ROOM_ACCESS_MUTE_USER                = 3485;
    public static ROOM_ACCESS_RIGHTS_GIVE              = 808;
    public static ROOM_ACCESS_RIGHTS_LIST              = 3385;
    public static ROOM_ACCESS_RIGHTS_REMOVE            = 2064;
    public static ROOM_ACCESS_RIGHTS_REMOVE_ALL        = 2683;
    public static ROOM_ACCESS_RIGHTS_REMOVE_OWN        = 3182;
    public static ROOM_CREATE                          = 2752;
    public static ROOM_DATA_INFO                       = 2230;
    public static ROOM_DATA_SETTINGS                   = 3129;
    public static ROOM_DATA_SETTINGS_SAVE              = 1969;
    ...
    public static UNIT_CHAT_TYPING                     = 1597;
    public static UNIT_CHAT_TYPING_STOP                = 1474;
    ...
    public static USER_DATA_FIGURE                     = 2730;
    public static USER_DATA_INFO                       = 357;
    public static USER_DATA_MOTTO                      = 2228;
    public static USER_DATA_PROFILE                    = 3265;
    public static USER_DATA_TAGS                       = 17;
    public static USER_EFFECT_ACTIVATE                 = 2959;
    public static USER_EFFECT_ENABLE                   = 1752;
    public static USER_HOME_ROOM                       = 1740;
    public static USER_INVENTORY_BADGES                = 2769;
    public static USER_INVENTORY_BADGES_CURRENT        = 2091;
    public static USER_INVENTORY_BADGES_CURRENT_UPDATE = 644;
    public static USER_INVENTORY_BOTS                  = 3848;
    public static USER_INVENTORY_CURRENCY              = 273;
    public static USER_INVENTORY_FURNITURE             = 3150;   // sent when in room
    public static USER_INVENTORY_FURNITURE2            = 3500;   // sent when not in room
    public static USER_INVENTORY_OUTFIT_SAVE           = 800;
    public static USER_INVENTORY_OUTFITS               = 2742;
    public static USER_INVENTORY_ROOM_FAVORITE         = 3817;
    public static USER_INVENTORY_ROOM_FAVORITE_REMOVE  = 309;
    public static USER_INVENTORY_ROOM_LIKE             = 3582;
    public static USER_INVENTORY_SUBSCRIPTION          = 3166;
    public static USER_MESSENGER_ACCEPT                = 137;
    public static USER_MESSENGER_CHAT                  = 3567;
    public static USER_MESSENGER_DECLINE               = 2890;
    public static USER_MESSENGER_FOLLOW                = 3997;
    public static USER_MESSENGER_FRIENDS               = 1523;
    public static USER_MESSENGER_INIT                  = 2781;
    public static USER_MESSENGER_RELATIONSHIPS         = 2138;
    public static USER_MESSENGER_RELATIONSHIPS_UPDATE  = 3768;
    public static USER_MESSENGER_REMOVE                = 1689;
    public static USER_MESSENGER_REQUEST               = 3157;
    public static USER_MESSENGER_REQUESTS              = 2448;
    public static USER_MESSENGER_ROOM_INVITE           = 1276;
    public static USER_MESSENGER_SEARCH                = 1210;
    public static USER_MESSENGER_UPDATES               = 1419;
