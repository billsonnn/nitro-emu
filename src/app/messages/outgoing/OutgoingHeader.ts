export class OutgoingHeader
{
    ...
    public static FURNITURE_WALL               = 1369;
    public static FURNITURE_WALL_ADD           = 2187;
    public static FURNITURE_WALL_REMOVE        = 3208;
    public static FURNITURE_WALL_UPDATE        = 2009;
